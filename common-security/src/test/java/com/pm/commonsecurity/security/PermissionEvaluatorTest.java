...
public class PermissionEvaluatorTest {
    ...
    void setUp() {
        ...
        rbacConfig.setRoles(Map.of(
                ...
                "ROLE_DEVELOPER", List.of("USER_SELF_READ", "USER_SELF_UPDATE", "CMT_CREATE", "CMT_UPDATE_OWN", "CMT_DELETE_OWN", "NOTI_READ", "NOTI_MARK_READ", "PRJ_READ", "TASK_CREATE", "TASK_READ", "TASK_UPDATE", "TASK_STATUS_CHANGE", "PRJ_PRIORITY_CHANGE"),
                "ROLE_PROJECT_MANAGER", List.of("USER_SELF_READ", "USER_SELF_UPDATE", "CMT_CREATE", "CMT_UPDATE_OWN", "CMT_DELETE_OWN", "NOTI_READ", "NOTI_MARK_READ", "PRJ_READ", "TASK_CREATE", "TASK_READ", "TASK_UPDATE", "TASK_STATUS_CHANGE", "PRJ_CREATE", "PRJ_UPDATE", "PRJ_DELETE", "PRJ_ARCHIVE", "PRJ_PRIORITY_CHANGE", "TASK_ASSIGN", "TASK_DELETE", "CMT_DELETE_ANY"),
                "ROLE_ADMIN", List.of("**")
        ));
