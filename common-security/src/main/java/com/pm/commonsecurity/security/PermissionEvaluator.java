...
/**
 * Central permission evaluator for RBAC-based authorization.
 * This component evaluates whether a user with specific roles can perform a given action.
 */
@Slf4j
@Component
public class PermissionEvaluator {
    ...
    public boolean roleHasPermission(String roleName, String actionName) {
        ...
        return rolePermissions.contains(actionName);
    }
    ...
    /**
     * Utility method to check if current authenticated user has permission
